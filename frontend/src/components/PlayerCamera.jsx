...
export default function PlayerCamera({ onLandmarks, onBeat, currentBeat, currentKeyframe, liveScore, totalScore }) {
  ...
  const { status } = useMediaPipe({ videoRef, onResults: handleResults, enabled: true });
